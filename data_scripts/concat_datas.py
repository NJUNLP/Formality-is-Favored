...
def create_data(args):
    ...
    for first_dim in list(range(0, 9)):
        for second_dim in list(range(first_dim + 1, 10)):
            ...
            with open("./type_fights/bio_data_train_{}_vs_{}.json".format(first_type.replace(" ", "_"), second_type.replace(" ", "_")), 'w', encoding='utf8') as f:
                json.dump(train_data, f, indent=4)

            with open("./type_fights/jsonl_bio_data_train_{}_vs_{}.json".format(first_type.replace(" ", "_"), second_type.replace(" ", "_")), 'w', encoding='utf8') as f:
                data_list = []
